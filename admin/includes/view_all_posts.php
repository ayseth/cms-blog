...
if(isset($_POST['checkBoxArray'])) {
    foreach($_POST['checkBoxArray'] as $postValueId){ //checkboxArray holds the id sent from bottom and postvalueId holds the value
...
//       
        ...
        echo"</tr>";
                ...
                // onClick=\"javascript: return confirm('Are you sure you want to DELETE'); \" ----> used for confirm box
