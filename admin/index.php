                        ...
                        <script type="text/javascript">
                            ...
                            function drawChart() {
                                var data = google.visualization.arrayToDataTable([
                                    ...
                                    <?php
                                    $element_text = ['All_posts','Active Post','Draft Posts', 'Comments', 'Unapproved Comment', 'User', 'Subscribers', 'Categories'];
                                    $element_count = [$post_counts,$post_published_count, $post_draft_count, $comment_counts, $unapproved_comment_count, $user_counts, $subscriber_count, $catagories_counts];
                                    for($i=0; $i<8; $i++) {
